# Generated by Django 2.2.10 on 2020-07-08 07:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Cl', 'Clothes'), ('Ui', 'Uniforms'), ('Ac', 'Accessories'), ('Je', 'Jewelry'), ('Wa', 'Watches'), ('Ba', 'Bags'), ('Sh', 'Shoes'), ('HA', 'Home Appliance'), ('Be', 'Beauty'), ('He', 'Health'), ('Ha', 'Hair'), ('Ap', 'Apartments'), ('Ho', 'Houses')], max_length=2)),
                ('label', models.CharField(choices=[('P', 'primary'), ('S', 'secondary'), ('D', 'danger'), ('R', 'Rent'), ('S', 'Sale')], max_length=1)),
